        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManufactureYear = table.Column<int>(type: "integer", nullable: false, defaultValue: 2025),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoatPorts", x => new { x.BoatId, x.PortId });
                    table.ForeignKey(
                        name: "FK_BoatPorts_Boats_BoatId",
                        column: x => x.BoatId,
                        principalTable: "Boats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoatPorts_Ports_PortId",
                        column: x => x.PortId,
